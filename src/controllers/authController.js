...
const register = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    console.error(error);
    res.status(500).json(formatResponse(1, 'error', 'An error occurred during registration'));
  }
});
...
const login = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    console.error(error);
    res.status(500).json(formatResponse(1, 'error', 'An error occurred during login'));
  }
});
